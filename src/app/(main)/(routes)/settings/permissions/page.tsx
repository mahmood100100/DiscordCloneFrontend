  ...
  if (!selectedServerId) {
    return (
      <div className="p-6 space-y-6">
        <div>
          <h1 className="text-2xl font-bold">Server Permissions</h1>
      ...
      <div className="p-6 space-y-6">
        <div className="flex items-center justify-between">
          ...
          <select 
            value={selectedServerId} 
            onChange={(e) => setSelectedServerId(e.target.value)}
            className="w-48 p-2 border border-gray-300 rounded-md bg-white text-black"
          >
            {servers.map((server) => (
              <option key={server.id} value={server.id}>
                {server.name}
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <Tabs defaultValue="current" className="space-y-4">
        <TabsList>
          <TabsTrigger value="current">Your Permissions</TabsTrigger>
          <TabsTrigger value="roles">Role Comparison</TabsTrigger>
        ...
        <TabsContent value="help" className="space-y-4">
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-semibold mb-2">How Permissions Work</h3>
                ...
                <div>
                  <h4 className="text-md font-medium mb-2">Role Hierarchy</h4>
                ...
                <div>
                  <h4 className="text-md font-medium mb-2">Channel Permissions</h4>
                ...
                <div>
                  <h4 className="text-md font-medium mb-2">Getting Help</h4>
                  <p className="text-sm text-muted-foreground">
